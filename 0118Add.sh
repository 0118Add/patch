#!/bin/bash
# https://github.com/0118Add/AutoBuild-OpenWrt
# common Module by 0118Add
...
sed -i '12a entry({"admin", "vpn"}, firstchild(), "GFW", 45).dependent = false' package/0118Add/ssrplus/luci-app-ssr-plus/luasrc/controller/shadowsocksr.lua
echo
TIME y "添加 小猫咪"
svn co https://github.com/vernesong/OpenClash/trunk/luci-app-openclash package/0118Add/luci-app-openclash
echo
TIME y "添加 Pass wall"
git clone https://github.com/xiaorouji/openwrt-passwall package/0118Add/passwall && git clone -b luci https://github.com/xiaorouji/openwrt-passwall && mv openwrt-passwall/luci-app-passwall package/0118Add/passwall && rm -rf openwrt-passwall
echo
TIME y "添加 Pass wall2"
git clone https://github.com/xiaorouji/openwrt-passwall2 package/0118Add/passwall2
sed -i '16a entry({"admin", "vpn"}, firstchild(), "GFW", 45).dependent = false' package/0118Add/passwall2/luci-app-passwall2/luasrc/controller/passwall2.lua
echo
TIME y "添加 Hello World"
git clone https://github.com/jerrykuku/luci-app-vssr package/0118Add/luci-app-vssr
echo
TIME y "添加 Bypass"
svn co https://github.com/kiddin9/openwrt-packages/trunk/luci-app-bypass package/0118Add/bypass
echo
TIME y "添加 SmartDNS"
...
echo
TIME y "添加 Dockerman"
svn co https://github.com/lisaac/luci-app-dockerman/trunk/applications/luci-app-dockerman package/0118Add/luci-app-dockerman
echo
TIME y "添加 IKP去广告"
git clone https://github.com/project-lede/luci-app-ikoolproxy package/0118Add/luci-app-ikoolproxy
echo
TIME y "添加 解除网易云音乐"
git clone https://github.com/UnblockNeteaseMusic/luci-app-unblockneteasemusic package/0118Add/luci-app-unblockneteasemusic
echo             
TIME b "插件 重命名..."
...
sed -i 's/解除网易云音乐播放限制/音乐解锁/g' package/0118Add/luci-app-unblockneteasemusic/luasrc/controller/unblockneteasemusic.lua
...
curl -fsSL https://raw.githubusercontent.com/0118Add/patch/main/mwan3helper_status.htm > ./feeds/luci/applications/luci-app-mwan3helper/luasrc/view/mwan3helper/mwan3helper_status.htm
TIME b "调整 Dockerman 到 服务 菜单"
sed -i 's/"admin",/"admin","services",/g' package/0118Add/luci-app-dockerman/luasrc/controller/*.lua
sed -i 's/"admin/"admin\/services/g' package/0118Add/luci-app-dockerman/luasrc/model/*.lua
sed -i 's/"admin/"admin\/services/g' package/0118Add/luci-app-dockerman/luasrc/model/cbi/dockerman/*.lua
sed -i 's/"admin/"admin\/services/g' package/0118Add/luci-app-dockerman/luasrc/view/dockerman/*.htm
sed -i 's/"admin/"admin\/services/g' package/0118Add/luci-app-dockerman/luasrc/view/dockerman/cbi/*.htm
TIME b "调整 bypass 到 GFW 菜单"
sed -i 's/services/vpn/g' package/0118Add/bypass/luci-app-bypass/luasrc/controller/*.lua
sed -i 's/services/vpn/g' package/0118Add/bypass/luci-app-bypass/luasrc/model/cbi/bypass/*.lua
sed -i 's/services/vpn/g' package/0118Add/bypass/luci-app-bypass/luasrc/view/bypass/*.htm
...
sed -i 's/services/vpn/g' package/0118Add/passwall/luci-app-passwall/luasrc/model/cbi/passwall/server/api/*.lua
sed -i 's/services/vpn/g' package/0118Add/passwall/luci-app-passwall/luasrc/view/passwall/app_update/*.htm
sed -i 's/services/vpn/g' package/0118Add/passwall/luci-app-passwall/luasrc/view/passwall/auto_switch/*.htm
...
sed -i 's/services/vpn/g' package/0118Add/passwall2/luci-app-passwall2/luasrc/controller/*.lua
sed -i 's/services/vpn/g' package/0118Add/passwall2/luci-app-passwall2/luasrc/model/cbi/passwall2/api/*.lua
sed -i 's/services/vpn/g' package/0118Add/passwall2/luci-app-passwall2/luasrc/model/cbi/passwall2/client/*.lua
sed -i 's/services/vpn/g' package/0118Add/passwall2/luci-app-passwall2/luasrc/model/cbi/passwall2/server/*.lua
sed -i 's/services/vpn/g' package/0118Add/passwall2/luci-app-passwall2/luasrc/model/cbi/passwall2/server/api/*.lua
sed -i 's/services/vpn/g' package/0118Add/passwall2/luci-app-passwall2/luasrc/view/passwall2/app_update/*.htm
sed -i 's/services/vpn/g' package/0118Add/passwall2/luci-app-passwall2/luasrc/view/passwall2/auto_switch/*.htm
sed -i 's/services/vpn/g' package/0118Add/passwall2/luci-app-passwall2/luasrc/view/passwall2/global/*.htm
sed -i 's/services/vpn/g' package/0118Add/passwall2/luci-app-passwall2/luasrc/view/passwall2/log/*.htm
sed -i 's/services/vpn/g' package/0118Add/passwall2/luci-app-passwall2/luasrc/view/passwall2/node_list/*.htm
sed -i 's/services/vpn/g' package/0118Add/passwall2/luci-app-passwall2/luasrc/view/passwall2/rule/*.htm
sed -i 's/services/vpn/g' package/0118Add/passwall2/luci-app-passwall2/luasrc/view/passwall2/server/*.htm
